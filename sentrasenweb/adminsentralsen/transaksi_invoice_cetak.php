...
<div id="preview"></div>
	...
	$query ="select * from transpengiriman_cust tc, mstcust mc where tc.notransc = '$_GET[token]' AND tc.nocust = mc.nocust";
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
												<th style="background-color:#FFC5B9;text-align:center;">Tgl Transaksi</th>
												<th style="background-color:#FFC5B9;text-align:center;">Invoice</th>
												<th style="background-color:#FFC5B9;text-align:center;">Resi</th>
                                                <th style="background-color:#FFC5B9;text-align:center;">Customer</th>
												<th style="background-color:#FFC5B9;text-align:center;">Tujuan</th>
												<th style="background-color:#FFC5B9;text-align:center;">Tipe Barang</th>
												<th style="background-color:#FFC5B9;text-align:center;">Payment</th>
												<th style="background-color:#FFC5B9;text-align:center;">Ongkir</th>
                                            </tr>
                                        </thead>
											<tbody>
											<tr>
											...
											<td style="background-color:white;color:black;text-align:left;"><?php echo $rt['noresi']; ?></td>
