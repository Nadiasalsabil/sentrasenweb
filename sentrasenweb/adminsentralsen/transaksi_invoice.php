...
<div id="preview"></div>
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Transaksi Invoice</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
	...
	$querytbl ="select * from transpengiriman_cust tc, mstcust mc where  tc.nocust = mc.nocust  order by notransc desc";
	...
	<td><div class="button-list">
        <button type="button" class="btn btn-warning m-b-10 m-l-5" onclick="gotoprintmode(\''.$rttbl["notransc"].'\')">
		cetak invoice
		</button>
    </div></td>
	</tr>';
...
function gotoprintmode(token){
	window.location.href = 'transaksi_invoice_cetak?token='+token;
}
</script>
</body>
</html>