    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">			
                ...
                <div class="row">
				   <div class="col-lg-6">
				   <input type="button" class="btn btn-primary" id="showbtn" onclick="showinputform(1)" value="input data tujuan">
                        <div id="div_input" class="card" style="display:none;">
                            <div class="card-title">
                                <h4>Input Master Tujuan</h4>
								<hr>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form id="form_in" name="form_in" action="action_iud" method="post" enctype="multipart/form-data" autocomplete="off">
                                        <div class="row">
                                            <div class="col-lg-12">
												...
												<center>
												<input type="hidden" name="sbmt_tujuan" >
												<input type="submit" id="sbmt_tujuan" class="btn btn-success" value="submit">
                                    ...
                                    <form id="form_up" name="form_up" action="action_iud" method="post" enctype="multipart/form-data" autocomplete="off">
                                        <div class="row">
                                            <div class="col-lg-12">
												...
												<center>
												<input type="hidden" name="updt_tujuan" >
												<input type="submit" id="updt_tujuan" class="btn btn-success" value="update">
...
$("#form_in").on("submit",(function(e) {
	...
	$.ajax({
			...
			beforeSend : function()
			{
				$("#sbmt_tujuan").prop("disabled",true);
			},
			success: function(data)
		    {
				...
				{
					$("#sbmt_tujuan").prop("disabled",false);
