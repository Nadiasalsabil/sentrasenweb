...
<div id="preview"></div>
	...
	/*
	$querytbl = "SELECT 
	transpengiriman.statusterkini,transpengiriman.sts,transpengiriman.tipebarang,transpengiriman.createddate,
	...
	<td style="color:black;"><div class="width:80px;">'.$rttbl["nmcust"].'</div></td>
	<td style="color:black;"><div class="width:80px;">'.$rttbl["kotatujuan"].'</div></td>
	<td style="color:black;">'.$rttbl["tipebarang"].'</td>
	<td style="color:black;">'.$rttbl["jumbrg"].'</td>
	<td style="color:black;">'.$rttbl["beratbrg"].'</td>
