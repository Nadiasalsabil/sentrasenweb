...
<head>
    ...
    <title>SENTRALSEN USER PANEL</title>
    <!-- Bootstrap Core CSS -->
...
<div id="preview"></div>
	...
	$no = 0;
	$querytbl = "SELECT *,tc.sts as stat from transpengiriman_cust tc, mstcust mc where tc.nocust=mc.nocust and tc.nocust='$user_id' order by notransc desc ";
...
function gotoprintmode(token){
	window.location.href = 'http://localhost/sentralsenweb/dashboard/laporan_invoice_detail?token='+token;
}
</script>
</body>
</html>