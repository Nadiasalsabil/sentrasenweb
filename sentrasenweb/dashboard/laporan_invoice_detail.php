        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
				   ...
				   <div class="col-lg-12">
				   <?php
$query = "SELECT *,tc.sts as stat from transpengiriman_cust tc , mstcust mc where tc.nocust=mc.nocust and notransc='$_GET[token]'";
	$exe_query = $use_pdo -> prepare($query);
	$exe_query -> execute();
	$rt = $exe_query -> fetch(PDO::FETCH_ASSOC);
	
	if($rt['stat'] == 0){ //pending
		$pengsts = '<span style="color:gray;">Pending</span>';
	}else if($rt['stat'] == 1){ //on progress
		$pengsts = '<span style="color:orange;">On Progress</span>';
	}else if($rt['stat'] == 2){ //selesai
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
												...
												<th style="background-color:#B9DCFF;text-align:center;">Detail Truck</th>
												<th style="background-color:#B9DCFF;text-align:center;">Supir</th>-->
												...
												<th style="background-color:#B9DCFF;text-align:center;">Status</th>
                                            </tr>
                                        </thead>
											<tbody>
											<tr>
											...
											Merk: <?php echo $rt['merktrk']; ?><br>
											Jenis: <?php echo $rt['jenistrk']; ?><br>
											Nomor Plat: <?php echo $rt['platnotrk']; ?></td>
											<td style="background-color:white;color:black;text-align:left;">
											Nama: <?php echo $rt['nmsupir']; ?><br>
											Telepon: <?php echo $rt['notelpsupir']; ?></td>-->
											...
											<td style="background-color:white;color:black;text-align:left;">
											<!--Paket: <?php echo $rt['kotatujuan']; ?><br>-->
											Biaya: Rp.<?php echo number_format(str_replace(',','',$rt['tarif'])); ?></td>
											<td style="background-color:white;color:black;text-align:center;"><?php echo $pengsts; ?></td>
											
											</tr>
											<tr>
											<td colspan="9" style="background-color:white;color:black;text-align:right;">-</td>
											</tr>
											<tr>
											<td colspan="8" style="background-color:white;color:black;text-align:right;">Jumlah Barang</td>
											<td style="background-color:white;color:black;text-align:right;"><?php echo $rt['jumbrg']; ?></td>
											</tr>
											<tr>
											<td colspan="8" style="background-color:white;color:black;text-align:right;">Total</td>
											<td style="background-color:white;color:black;text-align:right;">Rp.<?php echo number_format(str_replace(',','',$rt['total'])); ?></td>
											</tr>
											<tr>
											<td colspan="8" style="background-color:white;color:black;text-align:right;">Service</td>
											<td style="background-color:white;color:black;text-align:right;"><?php echo $rt['service']; ?></td>
											</tr>
											<tr>
											<td colspan="8" style="background-color:white;color:black;text-align:right;">Nomor Resi</td>
...
<?php }else{
	echo '<script>location.replace("http://localhost/sentralsenweb/dashborad/laporan_invoice");</script>';
} ?>